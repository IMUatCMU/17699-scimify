...
func (r *SimpleRepository) Create(resource *resource.Resource) error {
	r.repo[resource.Id] = resource
	return nil
}

// Get the resource indexed by id in the hash map
func (r *SimpleRepository) Get(id string) (*resource.Resource, error) {
	return r.repo[id], nil
}

// Not implemented by design
func (r *SimpleRepository) Replace(id string, resource *resource.Resource) error {
	return nil
}
...
// Not implemented by design
func (r *SimpleRepository) Query(filter string, sortBy string, ascending bool, pageStart int32, pageSize int32) ([]*resource.Resource, error) {
	return nil, nil
}